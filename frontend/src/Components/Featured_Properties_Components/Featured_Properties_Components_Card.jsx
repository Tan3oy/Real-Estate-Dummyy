                ...
                <section className="sec2-3">
                    <div className="property-details">
                        <div className="detail-item">
                            <img src={imgBed} alt="Bed-image" width="25px" className="icon"/>
                            &nbsp;
                            <span>{coefficientBed} Bed</span>
                        </div>
                        <div className="detail-item">
                            <img src={imgBath} alt="Bath-image" width="25px" className="icon"/>
                            &nbsp;
                            <span className="icon bath-icon"></span>
                            <span>{coefficientBath} Bath</span>
                        </div>
                        <div className="detail-item">
                            <img src={imgSqrt} alt="Sqrt-image" width="25px" className="icon"/>
                            &nbsp;
