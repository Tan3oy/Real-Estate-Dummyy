  ...
  return (
    <div>
      <section className="mx-28 mt-5">
        ...
        <div className="card-containers  gap-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-around cursor-pointer">
          <div className=" card-container-1  rounded-lg shadow-3xl  h-[338px] w-[330px] bg-green-500  hover:bg-gray-800 group transition duration-300 ease-in-out ">
          ...
          <div className=" card-container-2  rounded-lg shadow-3xl  h-[338px] w-[330px] bg-green-500 hover:bg-gray-800 group transition duration-300 ease-in-out">
            <div className="cut-border flex flex-col items-center text-center justify-center pt-[25px] pr-[25px] pl-[25px] h-full">
              <div className=" flex justify-center items-center border border-green-500 rounded-full h-[70px] w-[70px] group-hover:bg-gray-800">
          ...
          <div className=" card-container-3  rounded-lg shadow-3xl  h-[338px] w-[330px] bg-green-500 hover:bg-gray-800 group transition duration-300 ease-in-out">
            <div className="cut-border flex flex-col items-center text-center justify-center pt-[25px] pr-[25px] pl-[25px] h-full">
              <div className=" flex justify-center items-center border border-green-500 rounded-full h-[70px] w-[70px] group-hover:bg-gray-800">
          ...
          <div className=" card-container-4  rounded-lg shadow-3xl  h-[338px] w-[330px] bg-green-500 hover:bg-gray-800 group transition duration-300 ease-in-out">
            <div className="cut-border flex flex-col items-center text-center justify-center pt-[25px] pr-[25px] pl-[25px] h-full">
              <div className=" flex justify-center items-center border border-green-500 rounded-full h-[70px] w-[70px] group-hover:bg-gray-800">
