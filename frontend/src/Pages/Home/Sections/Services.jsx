    ...
    <div>
      <section className="mx-28 mt-8 mb-16">
        ...
        <div className="card-containers  gap-20 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-around cursor-pointer">
          <div className=" card-container-1  rounded-lg shadow-[0px_0px_10px] shadow-[#c1c1c1] h-[338px] lg:h-full w-[330px] lg:w-full bg-green-500  hover:bg-gray-800 group transition duration-300 ease-in-out ">
          ...
          <div className=" card-container-2  rounded-lg shadow-[0px_0px_10px] shadow-[#c1c1c1]  h-[338px] lg:h-full w-[330px] lg:w-full bg-green-500 hover:bg-gray-800 group transition duration-300 ease-in-out">
            <div className="cut-border flex flex-col items-center text-center justify-center pt-[25px] pr-[25px] pl-[25px] h-full">
              <div className=" flex justify-center items-center border border-green-500 rounded-full h-[70px] w-[70px] group-hover:bg-gray-800">
          ...
          <div className=" card-container-3  rounded-lg shadow-[0px_0px_10px] shadow-[#c1c1c1]  h-[338px] lg:h-full w-[330px] lg:w-full bg-green-500 hover:bg-gray-800 group transition duration-300 ease-in-out">
            <div className="cut-border flex flex-col items-center text-center justify-center pt-[25px] pr-[25px] pl-[25px] h-full">
              <div className=" flex justify-center items-center border border-green-500 rounded-full h-[70px] w-[70px] group-hover:bg-gray-800">
          ...
          <div className=" card-container-4  rounded-lg shadow-[0px_0px_10px] shadow-[#c1c1c1]  h-[338px] lg:h-full w-[330px] lg:w-full bg-green-500 hover:bg-gray-800 group transition duration-300 ease-in-out">
            <div className="cut-border flex flex-col items-center text-center justify-center pt-[25px] pr-[25px] pl-[25px] h-full">
              <div className=" flex justify-center items-center border border-green-500 rounded-full h-[70px] w-[70px] group-hover:bg-gray-800">
