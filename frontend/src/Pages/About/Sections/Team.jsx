        ...
        <section className='mx-28 mt-8 mb-16'>
            ...
            <div className='card-containers  gap-20 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-around cursor-pointer'>
               ...
               <div className='h-[320px] lg:h-full w-[321px] lg:w-full shadow-[0px_0px_10px] shadow-[#c1c1c1] rounded-xl group-hover:scale-110 transition-transform duration-300 ease-in-out group-hover:border-gray-500'>
                    ...
                    <div className='flex flex-col justify-center items-center text-center mt-4'>
                        <h1 className='group-hover:text-green-500 text-xl font-bold'>David Richard</h1>
               ...
               <div className='h-[320px] lg:h-full w-[321px] lg:w-full shadow-[0px_0px_10px] shadow-[#c1c1c1] rounded-xl group-hover:scale-110 transition-transform duration-300 ease-in-out group-hover:border-gray-500'>
                    ...
                    <div className='flex flex-col justify-center items-center text-center mt-4'>
                        <h1 className='group-hover:text-green-500 text-xl font-bold'>Matthew Anthony</h1>
                         <p className='font-medium text-green-500'>Founder</p>
                    </div>
                    <div className='flex flex-row mt-10 justify-center items-center gap-6'>
                    <div className='flex justify-center items-center border border-green-500 rounded-full h-[40px] w-[40px]  hover:bg-gray-800'>
                    <BsWhatsapp className='text-green-500 text-xl' />
                    </div>
                    <div className='flex justify-center items-center border border-green-500 rounded-full h-[40px] w-[40px]  hover:bg-yellow-200'>
                    <BsFacebook className='text-blue-600 text-xl' />
                    </div>
                    <div className='flex justify-center items-center border border-green-500 rounded-full h-[40px] w-[40px]  hover:bg-yellow-200'>
                    <BsLinkedin className='text-blue-600 text-xl' />
                    </div>
                   <div className='flex justify-center items-center border border-green-500 rounded-full h-[40px] w-[40px]  hover:bg-violet-700'>
                   <BsTwitterX className='text-xl' />
                   </div>
